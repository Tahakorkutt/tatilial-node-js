...
// Config ve env
dotenv.config();
const ormconfig = require("../node.tatilial.com/config/config");

// --- BASE PATH ---
const basePath = "/api";

// Auth middleware
const { checkUser } = require("../node.tatilial.com/middlewares/authMiddleware");
...
// MODELLER
const Customer = require("../node.tatilial.com/config/config");
const AfrikaVeOrtadoguTurlari = require("../node.tatilial.com/models/ AfrikaVeOrtadoguTurlari/AfrikaVeOrtadoguTurlariModel");
const dubaiturlari = require("../node.tatilial.com/models/DubaiTurlari/dubaiturlari");
const ortaLatinAmerikaTurlari = require("../node.tatilial.com/models/OrtaLatinAmerikaTurları/ortaLatinAmerıkaTurları");
const AsyaVeUzakDoguTuru = require("../node.tatilial.com/models/AsyaVeUzakDoguTuru/AsyaVeUzakDoguTuru");
const yunanAdalariTurlariModel = require("../node.tatilial.com/models/yunanAdalariTurları/yunanAdalarıTurlarıModel");
const iletisimModel = require("../node.tatilial.com/models/Iletısım/iletısımModel");
const rezervasyon = require("../node.tatilial.com/models/rezervation/rezervasyon");
